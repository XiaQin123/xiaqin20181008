...
public class WaseView extends View {
    private static final String TAG = "WaseView";
    private float fai = 0;
    ...
    public WaseView(Context context) {
        this(context,null);
    }

    public WaseView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public WaseView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }


    private OnWaseChangeListener listener;

    //浮动监听
    public interface OnWaseChangeListener {
        void onChanged(float y);
    }
    public void setOnWaseChangeListener(OnWaseChangeListener listener){
